...
The introduction ([A New Design Commons](../workshop-open-source-design/A New Design Commons.txt)) already states it: intellectual enclosure produces "things that limit our future possibles." The booklet takes that seriously as a structure — **three enclosures, three commons, and one shared warrant.**
...
- **Known near-duplicates to resolve while working:** `lecture-what-is-sustainable-graphic-design/WhatIsSGD.md` vs `lecture-what-is-sustainable-graphic-design/02021140252WhatIsSGD.md` (the latter is longer and has a "Define Sustainability" section the former lacks); the two `NDC lecture script.txt` files at root and in `workshop-open-source-design/` (**different content, same name, same length** — verified by hash); the two `20250121 173715-8A05BF57` transcripts; four `WhatIsSGD` PDFs in lecture-what-is-sustainable-graphic-design/.
