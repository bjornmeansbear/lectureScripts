---
what: what was cut to get Some Semiotics from 53 minutes to 30, and how to put it back
script: 2026-09-some-semiotics-script.md
staging: lecture-some-semiotics.md
transcript: transcript-2026-09-03.md (53:05 as delivered)
status: the 45-minute version is a restore from this file, not a rewrite
---

# Cuts and Restores

The test run on 3 September went **53:05**. The delivered script is thirty minutes. This is
the ledger — what came out, why, and the order to put it back in.

Nothing here is lost. Every cut is a section of the script that still exists, or material
sitting in `examples-and-references.md`.
...
**At 35 minutes** — take items 1 and 2. The catness parade and the theorists as people are
the two the room misses most, and neither needs a new slide.

**At 45 minutes** — add 3 and 4, and put Berger's second essay into §6, which
`examples-and-references.md` argues is the single strongest upgrade available to the whole
lecture. That's the version where §6 stops asserting that neutrality is ideological and
starts demonstrating it.

**Do not restore by relaxing the cuts inside sections.** The per-section trims — Peirce's
biography, the Saussure mustache, the Target logo run — were made because they were the
